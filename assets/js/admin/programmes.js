...
const COLLECTION=COLLECTIONS.PROGRAMMES;
const config={"search": ["title", "day", "branchName", "status"], "columns": ["title", "day", "startTime", "branchName", "status"], "branchScoped": true};
