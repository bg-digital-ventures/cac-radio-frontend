...
const COLLECTION=COLLECTIONS.PRAYER_REQUESTS;
const config={"search": ["fullName", "prayerRequest", "branchName", "status"], "columns": ["fullName", "branchName", "prayerRequest", "status"], "branchScoped": true};
